    ...
    if (valid) {
      ...
      if (commit.value == 'post') {
        ...
        axios.post('/admin/goods/insert', {
          ...
          console.log(res)
          action1.value = "api/admin/goods/indexImgUpload?goodsId=" + res.data
          action2.value = "api/admin/goods/detailImgUpload?goodsId=" + res.data
        ...
        //修改
        action1.value = "api/admin/goods/indexImgUpload?goodsId=" + upId.value
        action2.value = "api/admin/goods/detailImgUpload?goodsId=" + upId.value
        const con = reactive([])
